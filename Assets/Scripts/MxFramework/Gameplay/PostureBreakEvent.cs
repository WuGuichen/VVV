...
{
    /// <summary>
    /// Published when posture pressure crosses into the broken band.
    /// </summary>
    public readonly struct PostureBreakEvent : IEquatable<PostureBreakEvent>
    {
        public PostureBreakEvent(
            RuntimeFrame frame,
        ...
        {
            if (!entityId.IsValid)
                throw new ArgumentException("Posture break event entity id must be valid.", nameof(entityId));
        ...
        public bool Equals(PostureBreakEvent other)
        {
        ...
        {
            return obj is PostureBreakEvent other && Equals(other);
        }
