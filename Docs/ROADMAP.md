...
目标：把已有 Diagnostics、Logging、RuntimeHost、Resources、Gameplay 和 Combat 的只读状态统一接入开发者观察层，让后续 Debug UI、source adapters、event timeline、performance、simulation 和 hot reload 都有稳定入口。
