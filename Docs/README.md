...
| Gitea #195 / #196 / #201 / #197 / #198 / #199 / #200 | Character Control command sources, motion modifiers, pressure reaction, animation presentation, diagnostics and playable validation：新增 Local Input adapter、Runtime AI Planner command source、motion modifier / traction provider contract、pressure reaction bridge、MxAnimation presentation adapter、Debug UI source 和 Playable vertical slice。 |
...
| 版本 | 日期 | 变更 |
|------|------|------|
| 0.6.50 | 2026-05-18 | 扩展 Character Control v0.6：新增 Playable vertical slice，串联 Local Input、Runtime AI Planner command source、RuntimeHost、Combat Motion、Combat Action、pressure reaction、MxAnimation diagnostics、Debug UI snapshot 和 UI Toolkit 场景入口 |
